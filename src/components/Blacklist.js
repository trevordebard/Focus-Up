...
const DefaultButton = styled.button`
  ...
  background: linear-gradient(to right, ${colors.primary} 0%,  ${
    colors.primary
    ...
    renderSiteList = () => {
        ...
        if (sites.length !== 0) {
            return sites.map(site => (
                <p key={`${site}_${new Date().getTime()}`}>{site}</p>
            ));
        }
        return null;
    };
            ...
            <BlockedSite key={`${site}_${new Date().getTime()}`}>
                ...
                <StyledFontAwesomeIcon
                    ...
                    onClick={e => {
                        let item;
                        if (
                            e.target.parentNode.tagName.toLowerCase() === 'svg'
                        ) {
            ...
            <div>
                <BlacklistContainer>
                    ...
                    <InputContainer>
                        ...
                        />
                        <DefaultButton onClick={this.addSiteToList}>
                            ADD
                        </DefaultButton>
                    </InputContainer>
                    <br />
